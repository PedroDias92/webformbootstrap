...
namespace WebFormBootstrap
{
    public partial class SignIn : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from Users1 where Username='" + UserName.Text + "' and Password ='"+ Password.Text+"'", con);
                con.Open();
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    if (CheckBox1.Checked)
                    {
                        ...
                        Response.Cookies["UNAME"].Expires = DateTime.Now.AddDays(15); //passado 15 dias o cookie vai desativar
